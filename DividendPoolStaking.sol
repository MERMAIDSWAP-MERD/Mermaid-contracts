...
contract TokenStaking is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        // Reward stops accumulating after bonus end
    ...
    /// @param  _bonusStartBlock The block when rewards will end
    function setBonusStartBlock(uint256 _bonusStartBlock) external onlyOwner {
        require(
            _bonusStartBlock > startBlock,
            "new bonus end block must be greater than current"
        );
        startBlock = _bonusStartBlock;
    }
